...
& $FluentMigratorExePath /connection "Data Source=(local);Initial Catalog=LicenseManager;Integrated Security=SSPI;" /provider sqlserver2012 /assembly $LicenseManagerDLLPath
