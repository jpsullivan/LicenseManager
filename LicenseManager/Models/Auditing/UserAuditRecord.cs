...
namespace LicenseManager.Models.Auditing
{
    public class UserAuditRecord : AuditRecord<UserAuditAction>
    {
        ...
        public UserAuditRecord(User user, UserAuditAction action) : this(user, action, Enumerable.Empty<Credential>())
        {
        }

        public UserAuditRecord(User user, UserAuditAction action, Credential affected) : this(user, action, SingleEnumerable(affected))
        {
        }

        public UserAuditRecord(User user, UserAuditAction action, IEnumerable<Credential> affected) : base(action)
        {
